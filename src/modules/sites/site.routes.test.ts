...
describe('sites over the wire', () => {
  it('takes a new one and lists it back', async () => {
    ...
    const made = await api(app).post('/sites').send({
      code: 'BRN',
      name: 'Barnhill',
      town: 'Barnhill',
      ramps: 6,
  ...
  it('turns down a body carrying a field it does not know', async () => {
    ...
    const res = await api(app).post('/sites').send({
      code: 'BRN',
      name: 'Barnhill',
      town: 'Barnhill',
      ramps: 6,
  ...
  it('refuses a second one with the same code', async () => {
    ...
    const first = await api(app).post('/sites').send({
      code: 'BRN',
      name: 'Barnhill',
      town: 'Barnhill',
      ramps: 6,
    ...
    const again = await api(app).post('/sites').send({
      code: 'BRN',
      name: 'Barnhill',
      town: 'Barnhill',
      ramps: 6,
